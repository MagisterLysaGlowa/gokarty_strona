    ...
    <div class="container-fluid text-center pl-5 pr-5">
        ...
        <div class="row mt-3">
            ...
            <div class="col">
                ...
                <h1 class="fw-bolder mb-3">ZAWODY KARTINGOWE</h1>

                    <figure class="mb-4"><img class="img-fluid rounded w-75" src="/assets/images/mainPage.jpg"/></figure>

                    <section class="mb-5 text-justify">

                        <p>ZSTiO Limanowa słynie z wysokiego poziomy nauczania zawodowego wielu profilu technicznych, jednym z nich jest technik pojazdów samochodowych. W celu promocji tego profilu Nasza szkoła decyduje się na organizację zawodów.</p>
